...
<div class="mb-3{{ $errors->has($name) ? ' has-error' : '' }}">
    ...
    {{ Form::email($name, $value, array_merge(['class' => 'block appearance-none w-full py-1 px-2 mb-1 leading-normal bg-white text-gray-800 border border-gray-200 rounded'], $attributes)) }}
