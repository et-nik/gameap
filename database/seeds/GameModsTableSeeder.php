...
class GameModsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('game_mods')->insert([
            ...
            'local_repository' => '',
            'remote_repository' => '',
            'default_start_cmd' => './hlds_run -game valve +ip {ip} +port {port} +map {default_map} +maxplayers {maxplayers} +sys_ticrate {fps}',
        ...
        DB::table('game_mods')->insert([
            ...
            'local_repository' => '',
            'remote_repository' => '',
            'default_start_cmd' => './hlds_run -game cstrike +ip {ip} +port {port} +map {default_map} +maxplayers {maxplayers} +sys_ticrate {fps}',
            'passwd_cmd' => 'password {password}',
            'sendmsg_cmd' => 'amx_say "{msg}"',
            'chmap_cmd' => 'changelevel {map}',
            'srestart_cmd' => 'restart',
